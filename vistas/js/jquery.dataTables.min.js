...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activar para ordenar en modo ascendiente",sSortDescending:": activar para ordenar en modo descendiente"},oPaginate:{sFirst:"Primera",sLast:"Ultima",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay informacion disponible en la tabla",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ filas",sInfoEmpty:"Mostrando 0 a 0 de 0 filas",sInfoFiltered:"(filtered from _MAX_ total entries)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ entradas",sLoadingRecords:"Loading...",sProcessing:"Procesando...",sSearch:"Búsqueda:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron registros"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
